...
export default function AddProductPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!formData.nameAr || !formData.nameEn || !formData.category || !salePrice) {
      toast({
        title: t("خطأ", "Error"),
            ...
            {activeSection === 2 && (
              <div className="bg-background rounded-2xl border p-6 animate-slide-up">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-2">
                    <Label>{t("الفئة الفرعية", "Sub Category")}</Label>
                    <Select
                ...
                <div className="flex justify-between mt-6">
                  ...
                  <Button
                    type="button"
                    onClick={() => setActiveSection(productType === "outfit" ? 3 : getSectionIndex("colors"))}
                    className="gap-2"
                  >
                    {t("التالي", "Next")}
                    <ArrowLeft className="w-4 h-4" />
              ...
              <div className="bg-background rounded-2xl border p-6 animate-slide-up">
                ...
                <div className="flex justify-between mt-6">
                  <Button
                    type="button"
                    variant="outline"
                    onClick={() => setActiveSection(productType === "outfit" ? 3 : 2)}
                    className="gap-2 bg-transparent"
                  >
                    <ArrowRight className="w-4 h-4" />
                    {t("السابق", "Previous")}
                  </Button>
                  <Button type="button" onClick={() => setActiveSection(getSectionIndex("images"))} className="gap-2">
                    {t("التالي", "Next")}
                    <ArrowLeft className="w-4 h-4" />
                  </Button>
                </div>
            ...
            {activeSection === getSectionIndex("images") && (
              <div className="bg-background rounded-2xl border p-6 animate-slide-up">
                ...
                <div className="space-y-8">
                  ...
                  <div className="space-y-4">
                    <Label className="text-base font-semibold">
                      {t("صور إضافية (حد أقصى 4)", "Additional Images (Max 4)")}
                    </Label>
                ...
                <div className="flex justify-between mt-6">
                  <Button
                    type="button"
                    variant="outline"
                    onClick={() => setActiveSection(getSectionIndex("colors"))}
                    className="gap-2 bg-transparent"
                  >
                    <ArrowRight className="w-4 h-4" />
                    {t("السابق", "Previous")}
                  </Button>
                  <Button type="button" onClick={() => setActiveSection(getSectionIndex("pricing"))} className="gap-2">
                    {t("التالي", "Next")}
                    <ArrowLeft className="w-4 h-4" />
                  </Button>
                </div>
              ...
              <div className="bg-background rounded-2xl border p-6 animate-slide-up">
                ...
                <div className="flex justify-between mt-6">
                  <Button
                    type="button"
                    variant="outline"
                    onClick={() => setActiveSection(getSectionIndex("images"))}
                    className="gap-2 bg-transparent"
                  >
                    <ArrowRight className="w-4 h-4" />
                    {t("السابق", "Previous")}
                  </Button>
                  <Button type="button" onClick={() => setActiveSection(getSectionIndex("stock"))} className="gap-2">
                    {t("التالي", "Next")}
                    <ArrowLeft className="w-4 h-4" />
                  </Button>
                </div>
              ...
              <div className="bg-background rounded-2xl border p-6 animate-slide-up">
                ...
                <div className="flex flex-col sm:flex-row gap-4 mt-8 pt-6 border-t">
                  <Button
                    type="button"
                    variant="outline"
                    onClick={() => setActiveSection(getSectionIndex("pricing"))}
                    className="gap-2 bg-transparent"
                  >
                    <ArrowRight className="w-4 h-4" />
                    {t("السابق", "Previous")}
              ...
              <div className="bg-background rounded-2xl border p-6 animate-slide-up">
                ...
                <div className="flex justify-between mt-6">
                  <Button
                    type="button"
                    variant="outline"
                    onClick={() => setActiveSection(productType === "outfit" ? 7 : 6)}
                    className="gap-2 bg-transparent"
                  >
                    <ArrowRight className="w-4 h-4" />
                    {t("السابق", "Previous")}
