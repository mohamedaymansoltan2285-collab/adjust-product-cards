      ...
      <main className="max-w-[1600px] mx-auto px-4 md:px-6 py-6">
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          ...
          <div className="bg-background rounded-2xl p-2 mb-6 shadow-sm border">
            <TabsList className="grid grid-cols-11 gap-1 bg-transparent">
              {[
                ...
                { value: "featured", icon: Sparkles, label: t("المميز", "Featured") }, // Added Featured tab
                { value: "flashsale", icon: Zap, label: t("العروض", "Flash Sale") }, // Added Flash Sale tab
                { value: "floating", icon: Sparkles, label: t("العائمة", "Floating") }, // Added Floating Products tab
                { value: "moodboard", icon: Palette, label: t("المزاج", "Mood") }, // Added Mood Board tab
                { value: "rewards", icon: Award, label: t("المكافآت", "Rewards") }, // Added Rewards tab
                { value: "users", icon: Users, label: t("المستخدمون", "Users") }, // Added Users tab
                { value: "messages", icon: MessageSquare, label: t("الرسائل", "Messages") },
                { value: "statistics", icon: TrendingUp, label: t("الإحصائيات", "Statistics") },
              ].map((tab) => (
                <TabsTrigger
                  key={tab.value}
                  value={tab.value}
