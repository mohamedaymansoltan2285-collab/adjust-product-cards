          ...
          <div className="flex gap-2">
            <Button
              ...
              className={cn(
                ...
                canScrollLeft ? "hover:bg-primary hover:text-primary-foreground" : "opacity-50 cursor-not-allowed",
              )}
            >
            ...
            <Button
              ...
              className={cn(
                "rounded-full w-10 h-10 bg-background border-2 transition-all",
                canScrollRight ? "hover:bg-primary hover:text-primary-foreground" : "opacity-50 cursor-not-allowed",
              )}
            >
        ...
        <>
          <button
            ...
            className={cn(
              ...
              !canScrollLeft && "opacity-50 cursor-not-allowed hover:bg-white hover:text-foreground",
            )}
          >
            {language === "ar" ? <ChevronRight className="w-5 h-5" /> : <ChevronLeft className="w-5 h-5" />}
          </button>
          <button
            ...
            className={cn(
              ...
              "w-10 h-10 rounded-full bg-white shadow-lg items-center justify-center",
              "border hover:bg-primary hover:text-white transition-all",
              !canScrollRight && "opacity-50 cursor-not-allowed hover:bg-white hover:text-foreground",
            )}
          >
            {language === "ar" ? <ChevronLeft className="w-5 h-5" /> : <ChevronRight className="w-5 h-5" />}
          </button>
