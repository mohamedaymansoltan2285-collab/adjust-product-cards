                    ...
                    <div className="grid grid-cols-2 gap-2 px-2">
                      {CATEGORIES.map((cat) => (
                        <Link
                          ...
                          className="flex items-center justify-center gap-2 px-3 py-2.5 rounded-lg font-semibold text-sm text-slate-700 dark:text-slate-300 bg-slate-100 dark:bg-slate-800 hover:bg-[#0d3b66]/10 hover:text-[#0d3b66] transition-all duration-200 group"
                          onClick={() => setIsMobileMenuOpen(false)}
                        >
