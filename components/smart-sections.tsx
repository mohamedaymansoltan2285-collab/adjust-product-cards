...
import { SectionSkeleton } from "@/components/section-skeleton" // Import SectionSkeleton
      ...
      <div className="container mx-auto px-4 relative">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-8">
          <div className="space-y-3">
            ...
            <h2 className="text-3xl md:text-4xl font-serif font-bold text-foreground">{t("جديدنا", "New Arrivals")}</h2>
